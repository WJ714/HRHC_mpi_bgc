...
################################
#TA = {'name': 'TA', 'qc_name': 'TA_QC','vartype': 'predictor','revsign': False, 'monocon': '0'}
#SW_IN = {'name': 'SW_IN', 'qc_name': 'SW_IN_QC','vartype': 'predictor','revsign': False, 'monocon': '1'}
################################
#myvars={'TA': TA,'SW_IN': SW_IN}
